	  ...
	  _createClass(Game, [{
	    ...
	    value: function destroyCrabs(r) {
	      ...
	      (0, _util_func.objEach)(enemies, function (enemy) {
	        if ((0, _util_func.distance)(enemy.pos, player.pos) < r * 15) {
	          dead.push(enemy);
	...
	var Character = function (_Entity) {
	  ...
	  _createClass(Character, [{
	    ...
	    value: function getEquipped() {
	      ...
	      var char = { lvl: this.lvl, items: items };
	    ...
	    value: function render() {
	      for (var i = 0; i < 6; i++) {
	        ...
	        if (this.inventory[i]) {
	          ...
	          $itemval.text(this.inventory[i].val);
	          $del.show();
	          $info.show();
	        }
	      }
	...
	var Enemy = function (_Entity) {
	  ...
	  _createClass(Enemy, [{
	    ...
	    value: function removeBody() {
	      ...
	      if (Math.random() < 0.4 + 0.01 * this.lvl) {
	        this.dropItem();
	      }
	      stage.removeChild(body);
	    }

...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = function () {
	  function Board(stage) {
	    ...
	    this.hit = new Audio("./assets/sounds/hit.ogg");
	    this.death = new Audio("./assets/sounds/death.ogg");
	  ...
	  _createClass(Board, [{
	    ...
	    value: function render() {
	      var board = this;
	      this.game = new _game2.default(this.stage, this.assets, this.levelScreen, this.hit, this.death);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  function Game(stage, assets, levelScreen, hit, death) {
	...
	var Entity = function () {
	  ...
	  _createClass(Entity, [{
	    ...
	    value: function checkBounds(pos) {
	      ...
	      var xMax = 500 - bounds.width;
	      var yMax = 500 - bounds.height;
